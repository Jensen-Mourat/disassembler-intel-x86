...
class DisasmTest {
    ...
    @test 'negative disp'() {
        const val = Disassembler.generateInstructions('678A44FF');
        val.should.eql(JSON.parse("[{\"instruction\":\"mov\",\"operand1\":{\"register\":\"al\"},\"operand2\":{\"register\":\"si\",\"displacement\":\"-01\",\"pointer\":\"b\"},\"position\":0}]"));
    }
}
